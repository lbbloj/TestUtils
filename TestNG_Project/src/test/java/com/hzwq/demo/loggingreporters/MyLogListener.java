...
public class MyLogListener implements IReporter {

    private String logFileName = "MyTestLog.txt";
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
        ...
        this.sort(list);
        String dest = outputDirectory + File.separator+logFileName;
        System.out.println("dest::"+dest);
        this.outputResult(list, dest);
    }
